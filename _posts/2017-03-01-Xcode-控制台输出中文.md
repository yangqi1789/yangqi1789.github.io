...
创建一个字典并输出:
    ...
    NSDictionary *dic = @{@"name"  : @"BY",
                           @"My bolg" : @"http://yangqi1789.top",
                           @"count" : @(11),
                           @"strData" : strData,
                           @"dicData" : dicData,
                           @"set"     : set,
                           @"Unicode" : @"😀😁🤣😂😄",
                           @"contact" : @[@"BY Blog:http://yangqi1789.top",
                                          @"GitHub:https://github.com/yangqi1789",
...
代码及Demo地址：[GitHub](https://github.com/yangqi1789/BYFoundationLog)
